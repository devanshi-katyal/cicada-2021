...
Resources/code:
-Google Maps iframe used in the Get Hospitals page to generate map:- https://www.maps.ie/create-google-map/
-Article links used for the blog page; source directly linked in the website itself.
